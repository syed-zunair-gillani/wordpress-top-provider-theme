...
<!-- Hero Section -->
<section class="min-h-[calc(70vh-15rem)] h-[calc(70vh-110px)] flex items-center bg-cover bg-center bg-no-repeat bg-blend-overlay bg-black/50" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/main.jpg');">
