        ...
        <div id="menu" class="sm:w-2/3 bg-gray-100 w-full sm:bg-white shadow-xl sm:shadow-none z-10 sm:justify-end sm:static absolute left-0 sm:py-0 py-7 sm:px-0 px-5 flex items-center">
            <ul class="flex sm:flex-row flex-col sm:items-center md:gap-[3vw] gap-5">
                <li class="menu-item" data-submenu="submenu-tv">
                    ...
                    <ul id="submenu-tv" class="submenu bg-transparent sm:bg-white pl-5 sm:pl-0 border-l sm:border-none mt-1 md:!mt-[-34px] md:absolute static top-[3.7rem] md:w-40 w-full grid gap-3 z-50 md:shadow-xl">
                ...
                <li class="menu-item" data-submenu="submenu-internet">
                    ...
                    <ul id="submenu-internet" class="submenu bg-transparent sm:bg-white pl-5 sm:pl-0 border-l sm:border-none mt-1 md:!mt-[-34px] md:absolute static top-[3.7rem] md:w-40 w-full grid gap-3 z-50 md:shadow-xl">
