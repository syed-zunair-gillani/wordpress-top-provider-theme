...
class Tailwind_Nav_Walker extends Walker_Nav_Menu {
    public function start_lvl( &$output, $depth = 0, $args = null ) {
        ...
        $output .= "\n$indent<ul class=\"submenu !z-[11111] hidden border-l md:absolute md:bg-white mt-2 md:rounded-lg left-0 md:!text-gray-500 md:p-4 !ml-0 !grid md:!grid-cols-3 px-4\">\n";
    }
