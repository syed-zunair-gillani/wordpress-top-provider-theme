        ...
        <form class="sm:bg-gray-100 rounded-2xl shadow-xl w-full sm:w-auto" method="post" action="<?php echo esc_url( home_url( '/' ) ); ?>">
            <div class="relative sm:flex-row flex-col gap-2 flex sm:pl-3 items-center w-full m-auto serch_form">
                <div class="flex items-center bg-gray-100 w-full border border-gray-300 sm:border-none">
                    <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="absolute text-2xl sm:text-3xl ml-2 sm:ml-1 text-[#ef9831]" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex sm:flex-row flex-col gap-2 w-full sm:gap-0">
                                ...
                                <div class="mt-1 relative sm:border-l-[2px] border-gray-300">
                                    ...
                                    <div id="dropdownMenu" class="absolute mt-2 overflow-hidden sm:mt-1 w-full z-10 bg-gray-100 sm:rounded-b-2xl border border-gray-300 sm:border-none hidden">
                                        <ul class="max-h-56 rounded-md py-1 text-base overflow-auto focus:outline-none sm:text-sm">
                                            <li class="text-gray-900 cursor-pointer hover:bg-[#EF9831] hover:text-white select-none relative py-2 pl-3 pr-9" data-value="Internet">
                                                <div class="flex items-center">
                                                    <span class="ml-3 block font-normal truncate">Internet</span>
                                                </div>
                                            </li>
                                            <li class="text-gray-900 cursor-pointer hover:bg-[#EF9831] hover:text-white select-none relative py-2 pl-3 pr-9" data-value="TV">
                                                <div class="flex items-center">
                    ...
                    <button class="px-3 md:px-8 py-3 sm:py-[20px] w-full font-semibold text-white bg-[#ef9831] border-[#ef9831] sm:rounded-br-2xl sm:rounded-r-2xl" type="submit">Search</button>
                </div>
            </div>
        </form>
    </div>
