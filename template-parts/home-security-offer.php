            ...
            <?php
               $index = 0;
                ...
                if ($providers_query->have_posts()) :
                    ...
                    $speed =  $servicesInfo["home_security_services"]["summary_speed"];
                    $features_items = explode(',', $servicesInfo["home_security_services"]["summary_features"]);
                    $price = $servicesInfo["home_security_services"]["price"];
