...
<section class="pb-16 mt-10 md:mt-20">
    <div class="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 my-10 gap-10">
        <div>
            <h1 class="text-gray-800 text-3xl font-extrabold">Have question?</h1>
            <p class="md:text-sm text-gray-500 mt-4">We’re here to help. Leave a message and we’ll get you an answer soon.</p>
            ...
            <div class="mt-12">
                ...
                <ul class="flex mt-4 space-x-4">
                    <li class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                        <a href="https://www.facebook.com/topproviders.net" href="_blank">
                            <svg width="20px" height="20px" fill='#007bff'
                                viewBox="0 0 24 24">
                                <path
                    ...
                    <li class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                        <a href="https://www.instagram.com/top.providers/" href="_blank">
                            <svg width="20px" height="20px" fill='#007bff'
                                viewBox="0 0 24 24">
                                <path
